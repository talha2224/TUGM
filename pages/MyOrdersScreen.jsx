                ...
                <View>
                    {
                        products?.map((i) => (
                            <View key={i?._id} style={{ padding: 10, backgroundColor: '#1A1A1A', borderRadius: 10, marginVertical: 10, }}>
                                ...
                                <Text style={{ color: "#fff", fontSize: 15, marginTop: 8 }}>Seller Name : {i?.sellerId?.username}</Text>


                                <View style={{ justifyContent: "space-between", alignItems: "center", flexDirection: "row", marginTop: 15 }}>
                                    <TouchableOpacity style={styles.cancelButton}>
                                        <Text style={[styles.cancelText]}>{i?.delivered ? "Order Delivered":"Order Pending"}</Text>
                                    </TouchableOpacity>
